...
img = cv2.imread("org.jpeg")
WIDTH, HEIGHT, _ = img.shape

cell_width, cell_height = 5, 5  # Decreased cell size for more detail
...
font_scale = 0.3  # Decreased font scale for smaller characters
font_thickness = 1
...
cv2.imwrite("matrix.png", new_img)
